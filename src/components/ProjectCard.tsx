        ...
        <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          {liveUrl && liveUrl !== "#" && (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-full shadow-lg z-10"
          ...
          {githubUrl && githubUrl !== "#" && (
            <motion.a
              ...
              whileHover={{ scale: 1.1 }}
              whileTap={{ scale: 0.95 }}
              className="bg-gray-800 hover:bg-gray-900 text-white p-2 rounded-full shadow-lg z-10"
